...
- [extensions: Microsoft Edge 拡張](extensions/README.md)
    - [guides: ガイド](extensions/guides/README.md)
        - [accessibility: アクセシビリティー](extensions/guides/accessibility/README.md)
        - [adding-and-removing-extensions: 拡張を追加または削除する](extensions/guides/adding-and-removing-extensions/README.md)
    - API-support
        - [extension-API-roadmap: Microsoft Edge 拡張 API ロードマップ](extensions/API-support/extension-API-roadmap/README.md)
